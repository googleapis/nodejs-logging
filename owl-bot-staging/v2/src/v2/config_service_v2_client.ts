...
export class ConfigServiceV2Client {
  ...
  constructor(opts?: ClientOptions) {
    ...
    if (opts.fallback === 'rest') {
      ...
      },{selector: 'google.longrunning.Operations.GetOperation',get: '/v2/{name=*/*/locations/*/operations/*}',additional_bindings: [{get: '/v2/{name=projects/*/locations/*/operations/*}',},{get: '/v2/{name=organizations/*/locations/*/operations/*}',},{get: '/v2/{name=folders/*/locations/*/operations/*}',},{get: '/v2/{name=billingAccounts/*/operations/*}',}],
