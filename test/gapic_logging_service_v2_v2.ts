...
describe('v2.LoggingServiceV2Client', () => {
  ...
  describe('deleteLog', () => {
    ...
    it('invokes deleteLog without error using callback', async () => {
      ...
      client.innerApiCalls.deleteLog = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deleteLog(
  ...
  describe('writeLogEntries', () => {
    ...
    it('invokes writeLogEntries without error using callback', async () => {
      ...
      client.innerApiCalls.writeLogEntries = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listLogEntries', () => {
    ...
    it('invokes listLogEntries without error using callback', async () => {
      ...
      client.innerApiCalls.listLogEntries = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listLogEntriesStream without error', async () => {
      ...
      client.descriptors.page.listLogEntries.createStream = stubPageStreamingCall(
        expectedResponse
      );
    ...
    it('uses async iteration with listLogEntries without error', async () => {
      ...
      client.descriptors.page.listLogEntries.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
  ...
  describe('listLogs', () => {
    ...
    it('invokes listLogsStream without error', async () => {
      ...
      assert.strictEqual(
        (client.descriptors.page.listLogs.createStream as SinonStub).getCall(0)
