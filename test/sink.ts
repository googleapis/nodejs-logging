...
describe('Sink', () => {
  ...
  describe('create', () => {
    it('should call parent createSink in promise mode', async () => {
      const config = {};
  ...
  describe('delete', () => {
    it('should execute gax method', async () => {
      sink.logging.setProjectId = async (reqOpts) => {
    ...
    it('should accept gaxOptions', async () => {
      ...
      sink.logging.setProjectId = async () => {};
  ...
  describe('getMetadata', () => {
    ...
    it('should execute gax method', async () => {
      ...
      sink.logging.configService.getSink = async (reqOpts, gaxOpts) => {
        assert.deepStrictEqual(gaxOpts, undefined);
        return [];
      };
    ...
    it('should accept gaxOptions', async () => {
      ...
      sink.getMetadata(gaxOptions, assert.ifError);
    });
  ...
  describe('setFilter', () => {
    ...
    it('should call set metadata', async () => {
      sink.setMetadata = async (metadata, callback) => {
