...
describe('v2.MetricsServiceV2Client', () => {
    ...
    describe('getLogMetric', () => {
        ...
        it('invokes getLogMetric with error', async () => {
            ...
            assert.rejects(async () => { await client.getLogMetric(request); }, expectedError);
            assert((client.innerApiCalls.getLogMetric as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createLogMetric', () => {
        ...
        it('invokes createLogMetric with error', async () => {
            ...
            assert.rejects(async () => { await client.createLogMetric(request); }, expectedError);
            assert((client.innerApiCalls.createLogMetric as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateLogMetric', () => {
        ...
        it('invokes updateLogMetric with error', async () => {
            ...
            assert.rejects(async () => { await client.updateLogMetric(request); }, expectedError);
            assert((client.innerApiCalls.updateLogMetric as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteLogMetric', () => {
        ...
        it('invokes deleteLogMetric with error', async () => {
            ...
            assert.rejects(async () => { await client.deleteLogMetric(request); }, expectedError);
            assert((client.innerApiCalls.deleteLogMetric as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listLogMetrics', () => {
        ...
        it('invokes listLogMetrics with error', async () => {
            ...
            assert.rejects(async () => { await client.listLogMetrics(request); }, expectedError);
            assert((client.innerApiCalls.listLogMetrics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
