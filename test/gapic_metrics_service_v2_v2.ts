...
describe('v2.MetricsServiceV2Client', () => {
  ...
  describe('getLogMetric', () => {
    ...
    it('invokes getLogMetric without error using callback', async () => {
      ...
      client.innerApiCalls.getLogMetric = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getLogMetric(
  ...
  describe('createLogMetric', () => {
    ...
    it('invokes createLogMetric without error using callback', async () => {
      ...
      client.innerApiCalls.createLogMetric = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('updateLogMetric', () => {
    ...
    it('invokes updateLogMetric without error using callback', async () => {
      ...
      client.innerApiCalls.updateLogMetric = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deleteLogMetric', () => {
    ...
    it('invokes deleteLogMetric without error using callback', async () => {
      ...
      client.innerApiCalls.deleteLogMetric = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listLogMetrics', () => {
    ...
    it('invokes listLogMetrics without error using callback', async () => {
      ...
      client.innerApiCalls.listLogMetrics = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listLogMetricsStream without error', async () => {
      ...
      client.descriptors.page.listLogMetrics.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listLogMetrics
