...
is used to group multiple log entries under the load balancer request logs. See the [samples](https://github.com/googleapis/nodejs-logging/blob/master/samples/http-request.js)
